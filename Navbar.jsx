...
const Navbar = () => {
  ...
  // We are using token and userData from context
      ...
      <div className='flex items-center gap-4 '>
        {
          token && userData
            ...
            : 
              // FIX: Using NavLink ensures the browser navigates immediately without running potentially crashing JS code 
              // that caused the "Cannot set properties of undefined (setting 'userId')" error.
